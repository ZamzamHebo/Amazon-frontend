    ...
    <>
      ...
      {detail && (
        <div className={styles.productsDescription}>
          <h2 className={styles.describeptionTitle}>{category}</h2>
          <p>
            {title} <br /> <br /> {description || "No description available"}
          </p>
        </div>
      )}
    </>
...
//   detail,
// }) {
//   const { dispatch } = useContext(DataContext); // Updated
//   const notdisplayAdd = true; // Or calculate this based on some logic

//   function handleAddToCart() {
//     dispatch({
//       type: "ADD_TO_CART", // Fixed
//       item: { image, title, price, rating, id, category, description },
//     });
//   }
...
//         </div>
//         <div className={styles.product_spacer}></div>
//         <div className={styles.added_to_cart}></div>
//         {notdisplayAdd && (
//           <button
//             className={`${styles.add_to_cart_button} button_primary`}
//             onClick={handleAddToCart}
